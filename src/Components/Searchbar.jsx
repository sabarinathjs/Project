...
const Searchbar = () => {
    const Fruits=["All","Stove","Washing Machine","Fridge","Refrigerator","Microwave Oven","Cloth dryer","Induction Cooker","Heater","Air Conditioner","Television","Toaster","Dish Washers","Radiators","Mixers","Crock Pots","Pans","Iron Box","Kettles","Fans","Vacuum cleaners","Air Purifier","Torch","Lantern","Sewing Machine","Humidifiers","Air Fryer","Blender","Coffee maker","Freezers","Ice Maker","Laptop","Printer","Cassette","Pendrive","Chip","Speakers","Headphone","Bluetooth","Mouse","Monitor","Keyboard","Lights","Blubs"]
